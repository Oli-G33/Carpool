    ...
    <>
      <Box sx={{ maxWidth: 600, mx: 'auto', p: 2, color: '#D3D3D2' }}>
        ...
        <Typography variant="body1" sx={{ mb: 2 }}>
          Thank you for choosing to use our carpooling app for your daily
          commute. Before you start using our service, please read these terms
          and conditions carefully. By using our service, you agree to be bound
        ...
        <Typography variant="body1" sx={{ mb: 2 }}>
          1.2 Passengers are expected to arrive at the meeting point a few
          minutes prior to the agreed time. The driver will wait for a maximum
          of five minutes after the agreed time. If the passenger does not
          arrive within this time frame, the driver has the right to leave
          without them.
        </Typography>
        <hr />
        <Typography variant="h5" sx={{ mb: 2 }}>
        ...
        <Typography variant="body1" sx={{ mb: 2 }}>
          4.3 Passengers must not leave garbage or any other belongings in the
          car after the ride.
        </Typography>
        ...
        <Typography variant="body1" sx={{ mb: 2 }}>
          5.3 The carpooling app is not liable for any damage or loss that
          occurs to the driver's or passenger's car during the ride.
        </Typography>
        <Typography variant="body1" sx={{ mb: 2 }}>
